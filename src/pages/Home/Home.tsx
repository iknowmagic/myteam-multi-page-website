  ...
  return (
    <div className="overflow-hidden">
      ...
      <section className="relative lg:flex lg:justify-between bg-[#012f34] px-6 md:px-24 lg:px-40 py-16 md:py-24 lg:py-36">
        ...
        <div className="space-y-12 md:space-y-16 lg:mt-10 lg:w-136">
          ...
          <div className="flex md:flex-row flex-col items-center md:items-start md:pr-4">
            <div
              className="bg-[url('/assets/images/icon-person.svg')] bg-no-repeat bg-center w-20 h-20"
              aria-hidden="true"
            />
          ...
          <div className="flex md:flex-row flex-col items-center md:items-start md:pr-4">
            <div
              className="bg-[url('/assets/images/icon-cog.svg')] bg-no-repeat bg-center w-20 h-20"
              aria-hidden="true"
            />
            <div className="md:ml-6 md:text-left text-center">
              <h3 className="mt-4 md:mt-0 mb-2 font-bold text-[#f67e7e] text-lg">
          ...
          <div className="flex md:flex-row flex-col items-center md:items-start md:pr-4">
            <div
              className="bg-[url('/assets/images/icon-chart.svg')] bg-no-repeat bg-center w-20 h-20"
              aria-hidden="true"
            />
            <div className="md:ml-6 md:text-left text-center">
              <h3 className="mt-4 md:mt-0 mb-2 font-bold text-[#f67e7e] text-lg">
      ...
      <section className="relative bg-[#004047] px-6 md:px-24 lg:px-40 py-36 text-center">
        {/* Background patterns */}
        <div
          className="top-0 left-0 absolute bg-[url('/assets/images/bg-pattern-home-4-about-3.svg')] bg-no-repeat w-52 h-52"
          aria-hidden="true"
        />
        <div
          className="right-0 bottom-0 absolute bg-[url('/assets/images/bg-pattern-home-5.svg')] bg-no-repeat w-52 h-52"
          aria-hidden="true"
        />
        ...
        <div className="lg:flex lg:gap-x-6 lg:mt-20">
          ...
          <div className="flex flex-col items-center mb-9 lg:mb-0">
            <div
              className="bg-[url('/assets/images/icon-quotes.svg')] bg-no-repeat bg-top pt-10"
              aria-hidden="true"
            >
