  ...
  return (
    <div className="overflow-hidden">
      ...
      <section className="relative lg:flex lg:justify-between lg:items-end px-6 md:px-40 pt-0 md:pt-8 lg:pt-12 pb-44 md:pb-56 lg:pb-64">
        {/* Background patterns */}
        <div className="hidden lg:block top-12 top-14 -left-24 left-0 absolute bg-[url('/images/bg-pattern-home-1.svg')] bg-no-repeat bg-left-top w-52 h-52" />
        <div className="bottom-0 absolute bg-[url('/images/bg-pattern-home-2.svg')] bg-no-repeat bg-center bg-bottom w-full h-25" />
        ...
        <div className="lg:relative mx-auto lg:mx-0 mt-5 md:mt-6 lg:mt-0 lg:w-112 md:font-medium lg:font-semibold lg:text-left text-center">
          <div className="hidden lg:block lg:top-12 lg:absolute bg-[#79c8c7] mb-10 w-12 h-1"></div>
      ...
      <section className="relative lg:flex lg:justify-between bg-[#012f34] px-6 md:px-24 lg:px-40 py-16 md:py-24 lg:py-36">
        {/* Background Pattern */}
        <div className="top-0 -right-24 right-0 absolute bg-[url('/images/bg-pattern-home-3.svg')] bg-no-repeat bg-right-top w-52 h-52" />

        {/* Section Heading */}
        <h2 className="mb-14 md:mb-12 pr-28 lg:pr-0 lg:w-112 font-bold text-3xl lg:text-5xl">
          <div className="bg-[#f67e7e] mb-8 lg:mb-12 w-12 h-1"></div>
        ...
        <div className="space-y-12 md:space-y-16 lg:mt-10 lg:w-136">
          ...
          <div className="flex md:flex-row flex-col items-center md:items-start md:pr-4">
            <div className="bg-[url('/images/icon-person.svg')] bg-no-repeat bg-center w-20 h-20" />
          ...
          {/* Feature 2 */}
          <div className="flex md:flex-row flex-col items-center md:items-start md:pr-4">
            <div className="bg-[url('/images/icon-cog.svg')] bg-no-repeat bg-center w-20 h-20" />
            <div className="md:ml-6 md:text-left text-center">
              <h3 className="mt-4 md:mt-0 mb-2 font-bold text-[#f67e7e] text-lg">
                Easy to Implement
              </h3>
          ...
          {/* Feature 3 */}
          <div className="flex md:flex-row flex-col items-center md:items-start md:pr-4">
            <div className="bg-[url('/images/icon-chart.svg')] bg-no-repeat bg-center w-20 h-20" />
            <div className="md:ml-6 md:text-left text-center">
              <h3 className="mt-4 md:mt-0 mb-2 font-bold text-[#f67e7e] text-lg">
      ...
      <section className="relative bg-[#004047] px-6 md:px-24 lg:px-40 py-36 text-center">
        {/* Background patterns */}
        <div className="top-0 left-0 absolute bg-[url('/images/bg-pattern-home-4-about-3.svg')] bg-no-repeat w-52 h-52" />
        <div className="right-0 bottom-0 absolute bg-[url('/images/bg-pattern-home-5.svg')] bg-no-repeat w-52 h-52" />
        ...
        <div className="lg:flex lg:gap-x-6 lg:mt-20">
          ...
          <div className="flex flex-col items-center mb-9 lg:mb-0">
            <div className="bg-[url('/images/icon-quotes.svg')] bg-no-repeat bg-top pt-10">
