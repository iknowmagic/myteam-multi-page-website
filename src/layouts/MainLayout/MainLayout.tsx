  ...
  return (
    <div className="flex flex-col bg-[#014e56] min-h-screen font-['Livvic'] text-white">
      ...
      <header className="flex justify-between md:justify-start items-center px-6 md:px-10 lg:px-40 py-12 md:py-16 lg:py-18">
        <Link to="/" className="w-32 lg:w-40 h-8 lg:h-10">
        ...
        <div className="hidden md:block ml-auto">
          <Link to="/contact">
            <button className="hover:bg-white px-8 py-2 border-2 border-white rounded-full font-semibold hover:text-[#002529] text-lg transition-all">
              contact us
            </button>
          </Link>
        </div>
      ...
      <footer className="bg-[#002529] px-6 md:px-10 lg:px-40 py-16 font-semibold text-white md:text-left text-center">
        <div className="flex md:flex-row flex-col md:justify-between">
          ...
          <div className="flex flex-col items-center md:items-start">
            <img src="/images/logo.svg" alt="logo" className="h-6 lg:h-10" />
          ...
          {/* Address */}
          <div className="mt-10 md:mt-0 text-white/60 md:text-right">
            987 Hillcrest Lane
            <br />
            Irvine, CA
            <br />
        ...
        <div className="flex md:flex-row flex-col md:justify-between mt-10 md:mt-6">
          <div className="flex justify-center md:justify-start">
            <a
              href="#"
              className="hover:opacity-70 mx-2 transition-opacity"
              aria-label="Facebook"
            >
